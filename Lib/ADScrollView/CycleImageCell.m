...
-(void)createSubViews
{
    ...
    _detaiLabel = [[UILabel alloc]initWithFrame:CGRectMake(7, 7, 350, 30)];//修改
    _detaiLabel.textColor = [UIColor redColor];
...
//修改
-(void)setDetaiLabel:(UILabel *)detaiLabel{
    _detaiLabel = detaiLabel;
    
    _detaiLabel.text = detaiLabel.text;
